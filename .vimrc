...
autocmd FileType php,python,c,java,perl,shell,bash,vim,ruby,cpp set sw=2
autocmd FileType php,python,c,java,perl,shell,bash,vim,ruby,cpp set ts=2
autocmd FileType php,python,c,java,perl,shell,bash,vim,ruby,cpp set sts=2
